...
class GridWorldContinuous(gym.Env):
    ...
    def __init__(self, get_reward=None, dim=6, max_delta=0.2, wall_width=2.5):
    ...
    def _step(self, action):
        ...
        reward, done = self.get_reward(self.state, reward, done, None)
    ...
    def _get_sample_points(self, size):
